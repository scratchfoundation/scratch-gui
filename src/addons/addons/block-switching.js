...
export default async function ({ addon, global, console, msg }) {
  ...
  if (true || addon.settings.get("motion")) {
  ...
  if (true || addon.settings.get("looks")) {
  ...
  if (true || addon.settings.get("sound")) {
  ...
  if (true || addon.settings.get("event")) {
  ...
  if (true || addon.settings.get("control")) {
  ...
  if (true || addon.settings.get("operator")) {
  ...
  if (true || addon.settings.get("sensing")) {
  ...
  if (true || addon.settings.get("data")) {
  ...
  if (true || addon.settings.get("extension")) {
  ...
  const customContextMenuHandler = function (options) {
    if (true || addon.settings.get("border")) {
    ...
    for (const opcodeData of switches) {
      ...
      if (isNoop && !(true || addon.settings.get("noop"))) {
        continue;
      }
