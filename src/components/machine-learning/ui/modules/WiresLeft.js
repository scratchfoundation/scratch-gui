...
class WiresLeft {
    ...
    render(once) {
        ...
        for (let index = 0; index < this.learningClasses.length; index += 1) {
            let start = {
                ...
                // y: this.startY + this.offsetvalue
            };
    ...
    camMode() {
        ...
        this.offsetY = -(this.learningClasses.length-1);
    ...
    highlight(index) {
        ...
        this.start();
        let currentClass = this.element.querySelector(`.wire-left-${index}`);
    ...
    dehighlight(index) {
        ...
        for(let i=0;i<this.learningClasses.length;i++){
            let currentClass = this.element.querySelector(`.wire-left-${i}`);
