...
SoundEditor.propTypes = {
    ...
    onCopyToNew: PropTypes.func,
    onDelete: PropTypes.func,
    onEcho: PropTypes.func,
    onFadeIn: PropTypes.func,
    onFadeOut: PropTypes.func,
    onFaster: PropTypes.func,
    onLouder: PropTypes.func,
    onMute: PropTypes.func,
    onPaste: PropTypes.func,
    onPlay: PropTypes.func,
    onRedo: PropTypes.func,
    onReverse: PropTypes.func,
    onRobot: PropTypes.func,
    onSetTrim: PropTypes.func,
    onSlower: PropTypes.func,
    onSofter: PropTypes.func,
    onStop: PropTypes.func,
    onUndo: PropTypes.func,
    playhead: PropTypes.number,
    setRef: PropTypes.func,
    tooLoud: PropTypes.bool,
