...
import { openfullScreenPreview, closeFullScreenPreview } from '../reducers/modals';
...
class StageActionWrapper extends React.Component {
    ...
    handleKeyPress (event) {
        if (event.key === 'Escape' && this.props.isFullScreen) {
            ...
            this.props.onRequestCloseFullScreenPreview()
        }
    }
    handleSetFullScreen () {
        this.props.onSetStageFull()
        this.props.onRequestOpenFullScreenPreview()
    }
    render () {
        const {
            ...props
...
const mapDispatchToProps = dispatch => ({
    ...
    onRequestOpenFullScreenPreview: () => dispatch(openfullScreenPreview()),
